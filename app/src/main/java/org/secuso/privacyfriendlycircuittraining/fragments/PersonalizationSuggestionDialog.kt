...
object PersonalizationSuggestionDialog {
    ...
    fun show(activity: AppCompatActivity) {
        AbortElseDialog.build(activity) {
            title = {
                activity.getString(R.string.alert_personalization_title)
            }

            content = {
                activity.getString(R.string.alert_personalization_message)
            }
            ...
            onShow = {
                PrefManager.setPersonalizationDialogShown(
                    activity,
                    true
                )
            }
